...
class Account extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (
      this.props.delivery_user !== nextProps.delivery_user &&
      nextProps &&
      nextProps.delivery_user &&
      nextProps.delivery_user.data
    ) {
      ...
      <React.Fragment>
        ...
        <div className="d-flex justify-content-between nav-dark">
          <div className="delivery-tab-title px-20 py-15">
            ...
            {(delivery_user && delivery_user.data && delivery_user.data.name) ||
              ""}
          </div>

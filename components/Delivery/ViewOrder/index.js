...
class ViewOrder extends Component {
  ...
  __getDirectionToUser = (user_order_loaction) => {
    ...
    try {
      ...
      JSON.parse(user_order_loaction);
      const directionUrl =
        "http://maps.google.com/maps?q=" + user_order_loaction;
      window.open(directionUrl, "_blank");
    }
  };
                ...
                {this.state.already_accepted ? (
                  ...
                  <React.Fragment>
                    ...
                    >
                      ...
                      {order.cash_change_amount !== null &&
                        order.cash_change_amount !== "0" && (
                          <div className="p-15">
                        ...
                        !this.state.delivered && (
                          <div className="px-30">
                            <CountDownTimer
                              ...
                              timeExtended={
                                !!this.props.deliveryStatus.extend_time
                              }
                              extendedTime={
                                this.props.deliveryStatus.extend_time
                              }
                      ...
                      <div className="pt-15 px-15">
                        ...
                        <div className="p-15 single-order-items-list">
                          ...
                          {localStorage.getItem(
                            "showPriceAndOrderCommentsDelivery"
                          ) === "true" && (
                            <React.Fragment>

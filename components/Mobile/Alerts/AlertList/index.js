      ...
      <React.Fragment>
        <div className="row">
          <div className="col-md-12">
            <div
              className={`block block-link-shadow mb-3 ${alert.is_read &&
                "bg-grey"}`}
              style={{
                boxShadow: !alert.is_read
                  ? "rgba(225, 225, 225, 0.34) 0px 1px 4px 1px"
                  : "0",
            ...
            >
              ...
              <div className="block-content block-content-full clearfix py-2">
                ...
                <div>
                  <div
                    className={`font-w600 font-size-h4 mb-5 ${alert.is_read &&
                      "text-muted"}`}
                  >
                    {data.title}
                  </div>
                  <div className="font-size-sm text-muted">
                    {data.is_wallet_alert &&

      ...
      <React.Fragment>
        ...
        <BackWithSearch
          ...
          title={
            user.running_order &&
            "#" +
              user.running_order.unique_order_id.substr(
                user.running_order.unique_order_id.length - 8
              )
          }
          disable_search={true}
          back_to_home={false}
        ...
        {user.running_order && (
          <React.Fragment>
            {localStorage.getItem("showMap") === "true" &&
              user.running_order.delivery_type === 1 && (
                <Map
            ...
            >
              ...
              {this.state.show_delivery_details && user.delivery_details.photo && (
                <div className="block block-link-shadow pb-2 m-0 delivery-assigned-block">
                  <div className="block-content block-content-full clearfix py-0">
                    <div className="float-right">
                      <img
                        src={
                          "/assets/img/delivery/" + user.delivery_details.photo
                        }
                  ...
                  <React.Fragment>
                    ...
                    <div>
                      <CountDownTimer
                        variant={"progressBar"}
                        orderPreapared={
                          this.props.deliveryStatus.orderstatus_id === 7
                        }
                        timeExtended={!!this.props.deliveryStatus.extend_time}
                        extendedTime={this.props.deliveryStatus.extend_time}
                        defaultTime={
                          this.props.deliveryStatus.order_prepare_time
                        }
                        order_accepted_at={
                          this.props.deliveryStatus.order_accepted_at
                        }
                        order_prepared_at={
                          this.props.deliveryStatus.order_prepared_at
                        }
                      />
                    </div>
                    <hr className="m-0" />
...
export default connect(
  mapStateToProps,
  { updateUserInfo, getDeliveryStatus }
)(RunningOrder);
